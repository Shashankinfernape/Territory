    ...
    <div className="fade-in" style={{ minHeight: '80vh', padding: '4rem 1rem' }}>
      <div style={{ maxWidth: '680px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.25rem', marginBottom: '2.5rem' }}>
          {[
            ...
            <div key={item.title} style={{
              ...
              <div style={{ fontWeight: 600, color: '#2C2C2C', fontSize: '0.9375rem', fontFamily: "'Poppins', sans-serif" }}>{item.title}</div>
        ...
        <div style={{ background: '#ffffff', borderRadius: '12px', padding: '2rem', boxShadow: 'rgba(36, 36, 36, 0.05) 0px 4px 8px 0px' }}>
          <h2 style={{ fontFamily: "'Poppins', sans-serif", fontSize: '1.125rem', fontWeight: 600, color: '#2C2C2C', marginBottom: '1.5rem', letterSpacing: '0.01em' }}>
            Send a Message
          </h2>
          <form style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div>
                <label style={{ display: 'block', fontSize: '0.8125rem', fontWeight: 500, color: '#2C2C2C', marginBottom: '0.4rem', letterSpacing: '-0.2px' }}>Full Name</label>
                <input id="contact-name" className="form-input" type="text" required placeholder="Your name" />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '0.8125rem', fontWeight: 500, color: '#2C2C2C', marginBottom: '0.4rem', letterSpacing: '-0.2px' }}>Phone / Email</label>
                <input id="contact-contact" className="form-input" type="text" required placeholder="Phone or email" />
              </div>
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '0.8125rem', fontWeight: 500, color: '#2C2C2C', marginBottom: '0.4rem', letterSpacing: '-0.2px' }}>Subject</label>
              <input id="contact-subject" className="form-input" type="text" required placeholder="What's this about?" />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '0.8125rem', fontWeight: 500, color: '#2C2C2C', marginBottom: '0.4rem', letterSpacing: '-0.2px' }}>Message</label>
